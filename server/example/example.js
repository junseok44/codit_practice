// 제__조 라고 시작하는거는 하나의 단락으로 띄운다.
// \n 다음에 ②가 오면은, 그것도 하나의 단락으로 띄운다.
// \n 다음에 <신 설>이 오면, 그것도 하나의 단락으로 띄운다.

// 그런 상황이 아니면, 그 다음 array로 오더라도 merge한다.
// 현행, 개정안으로 시작하는 부분부터 시작한다.

// table은 어떤 식으로? [["ㅇㄹㅇㄹ","ㅇㄹㅇㄹ"],[]] 이렇게 오고, 하나의 table은 하나로 끊어서,

// 그런 다음에, 클라이언트에서는, for i in range(n) 이렇게 해서, 왼쪽에는 data[0][i]을, 오른쪽에는 data[0][i]을 넣어주면 된다.
